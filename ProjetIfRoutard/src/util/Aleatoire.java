...
/**
 * Cette classe regroupe des m̩thodes statiques pour g̩n̩rer al̩atoirement des nombre entiers.
 */
public class Aleatoire {
    ...
    /**
     * Cette m̩thode main() permet de tester cette classe avant de l'int̩grer dans votre code.
     * Elle utilise chacune des m̩thodes (statiques) de la classe pour illustrer leur fonctionnement.
